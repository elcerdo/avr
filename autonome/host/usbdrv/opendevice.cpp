...
static int  _shellStyleMatch(const char *text, const char *p)
{
...
static int shellStyleMatch(const char *text,const char *pattern)
{
...
int usbOpenDevice(usb_dev_handle **device, int vendorID, const char *vendorNamePattern, int productID, const char *productNamePattern, const char *serialNamePattern, FILE *printMatchingDevicesFp, FILE *warningsFp)
{
struct usb_bus      *bus;
